...
void i2c_config(I2C_Handler_t *ptrHandlerI2C){
	...
	/* 2. Reiniciamos el periférico, de forma que inica en un estado conocido */
...
//	}
	...
	if(ptrHandlerI2C->modeI2C == I2C_MODE_SM){
		...
		// Controla el tiempo t-rise máximo
...
/**/
void i2c_sendSlaveAddressRW(I2C_Handler_t *ptrHandlerI2C, uint8_t slaveAdress, uint8_t readOrWrite){
	...
	ptrHandlerI2C->ptrI2Cx->DR = (slaveAdress << 1) | readOrWrite;
...
void i2c_sendMemoryAddress(I2C_Handler_t *ptrHandlerI2C, uint8_t memAddr){
	/* 4. Enviamos la direccióm de memoria que deseamos leer */
	ptrHandlerI2C->ptrI2Cx->DR = memAddr;

	/* 4.1 Esperemos hasta que el byte sea transmitido  */
...
uint8_t i2c_readSingleRegister(I2C_Handler_t *ptrHandlerI2C, uint8_t regToRead){
	...
	/* 0. Creamos unas variables auxiliar para recibir el dato que leemos */
	uint8_t auxRead = 0;
