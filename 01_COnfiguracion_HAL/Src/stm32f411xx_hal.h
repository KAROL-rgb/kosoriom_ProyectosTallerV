 ...
 *
 * Comenzar de arriba hacia abajo como se muestra en la tabla. Indica USB_OTG_FS (AHB2)
 *
 ...
 * 6.3.1 (RCC_CR) hasta el 6.3.12 (RCC_APBZENR), 6.3.17 (RCC_BDCR) y 6.3.18 (RCC_CSR)
 *
...
typedef struct
{
	...
	volatile uint32_t reserved6;     //reserved                                 ADDR_OFFSET:      Ox48
	...
	volatile uint32_t PLLI25CFGR;    //PLLI25 configuration register            ADDR_OFFSET:      0x84
